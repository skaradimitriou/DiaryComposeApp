...
import com.stathis.diarycomposeapp.presentation.components.GoogleButton
...
@Composable
@Preview
fun AuthenticationContentNoLoadingPreview() {
...
@Composable
@Preview
fun AuthenticationContentLoadingPreview() {
